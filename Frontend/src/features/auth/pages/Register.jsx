...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('Account created successfully! Welcome to Cartique.');
      setFormData({
        fullName: '',
        email: '',
        contactNumber: '',
    ...
    <div className="h-screen w-screen bg-[#131313] text-[#e5e2e1] flex flex-col justify-between font-['Inter'] selection:bg-[#10b981]/20 selection:text-[#34d399] overflow-hidden">
        ...
        <div className="w-full max-w-[440px] bg-[#1e1e1e]/90 backdrop-blur-xl rounded-2xl p-6 sm:p-7 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.7)] border border-[#2d2d2d]/80 relative flex flex-col max-h-[calc(100vh-90px)] my-auto z-10">
          ...
          <div className="mb-4 flex-shrink-0">
            ...
            <p className="text-[11px] sm:text-xs text-[#d3c5ac] font-normal leading-relaxed">
              Join the elite. Experience cinematic precision in every interaction.
            </p>
          </div>
          ...
          {successMessage && (
            <div className="mb-4 p-3 bg-[#10b981]/10 border border-[#10b981]/30 rounded-xl flex items-start gap-2.5 animate-fadeIn flex-shrink-0">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-semibold text-[#34d399]">Registration Successful</span>
          ...
          {errors.submit && (
            <div className="mb-4 p-3 bg-[#93000a]/20 border border-[#ffb4ab]/30 rounded-xl flex items-start gap-2.5 animate-fadeIn flex-shrink-0">
              ...
              <div className="flex flex-col">
                <span className="text-xs font-semibold text-[#ffb4ab]">Registration Error</span>
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="flex flex-col gap-3.5 overflow-y-auto pr-1 flex-1">
            {/* Full Name Field */}
            <div>
              <div className="flex items-center justify-between mb-1">
                <label htmlFor="fullName" className="font-['Inter'] text-[10px] sm:text-[11px] font-medium uppercase tracking-wider text-[#d3c5ac]">
                  Full Name
                </label>
                {errors.fullName && (
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-[#131313] text-[#e5e2e1] text-xs sm:text-sm px-3 py-2 rounded-lg border-b ${
                    errors.fullName ? 'border-[#ffb4ab] focus:ring-[#ffb4ab]/20' : 'border-[#2d2d2d] focus:border-[#10b981] focus:ring-[#10b981]/20'
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label htmlFor="contactNumber" className="font-['Inter'] text-[10px] sm:text-[11px] font-medium uppercase tracking-wider text-[#d3c5ac]">
                  Contact Number
                </label>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-[#131313] text-[#e5e2e1] text-xs sm:text-sm px-3 py-2 rounded-lg border-b ${
                    errors.contactNumber ? 'border-[#ffb4ab] focus:ring-[#ffb4ab]/20' : 'border-[#2d2d2d] focus:border-[#10b981] focus:ring-[#10b981]/20'
                  } focus:ring-1 focus:outline-none transition-all duration-200 placeholder-[#474746] shadow-inner`}
                />
              </div>
            </div>
            ...
            <div className="pt-0.5 flex-shrink-0">
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  ...
                  />
                  <div className="w-4 h-4 bg-[#131313] border border-[#2d2d2d] rounded peer-checked:bg-[#10b981] peer-checked:border-[#10b981] peer-focus:ring-2 peer-focus:ring-[#10b981]/20 transition-all duration-200 flex items-center justify-center group-hover:border-[#6e7979]">
                    <span className="material-symbols-outlined text-[#002919] text-[11px] opacity-0 peer-checked:opacity-100 transition-opacity font-bold">
                      check
                    </span>
                  </div>
                </div>
                <div className="flex flex-col">
                  <span className="text-xs sm:text-sm font-medium text-[#e5e2e1] group-hover:text-[#34d399] transition-colors">
                    Register as Seller
                  </span>
                </div>
              </label>
      ...
      <footer className="w-full px-8 lg:px-16 py-3 flex flex-col sm:flex-row items-center justify-between border-t border-[#1e1e1e]/80 text-[11px] text-[#b7b5b4] gap-2 backdrop-blur-md flex-shrink-0">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link to="/login" className="hover:text-[#34d399] transition-colors flex items-center gap-1.5 text-[#d3c5ac] font-medium">
